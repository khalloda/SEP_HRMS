...
<div class="d-flex justify-content-between align-items-center">
    <div>
        <h1 class="h3 mb-1 brand-dark-green">{{ __('hrms.edit') }} {{ __('hrms.employee.title') }}</h1>
    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            ...
                            maxlength="160"
                            placeholder="{{ __('hrms.employee.optional_arabic_name') }}">
                        @error('arabic_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    maxlength="20"
                                    placeholder="{{ __('hrms.employee.national_id_or_passport') }}">
                                @error('national_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text text-muted">
                                    <i class="fas fa-lock"></i> {{ __('hrms.employee.encrypted_info_note') }}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('department_id') is-invalid @enderror"
                                    ...
                                    name="department_id"
                                    required>
                                    <option value="">{{ __('hrms.employee.select_department') }}</option>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('position_id') is-invalid @enderror"
                                    ...
                                    name="position_id"
                                    required>
                                    <option value="">{{ __('hrms.employee.select_position') }}</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('employment_type_id') is-invalid @enderror"
                                    ...
                                    required>
                                    <option value="">{{ __('hrms.employee.select_employment_type') }}</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('manager_id') is-invalid @enderror"
                                    id="manager_id"
                                    name="manager_id">
                                    <option value="">{{ __('hrms.employee.select_manager_optional') }}</option>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body d-grid gap-2">
                    <button type="submit" class="btn btn-brand-primary btn-lg">
                        <i class="fas fa-save"></i> {{ __('hrms.update') }} {{ __('hrms.employee.title') }}
                    </button>
                    <a href="{{ route('employees.show', $employee) }}" class="btn btn-outline-secondary">
            ...
            <div class="card mb-4">
                <div class="card-header card-header-custom">
                    <h5 class="mb-0">
                        <i class="fas fa-info-circle"></i> {{ __('hrms.employee.current_information') }}
                    </h5>
                </div>
                <div class="card-body">
                    <div class="small text-muted">
                        ...
                        <div class="mb-2">
                            <strong>{{ __('hrms.employee.created') }}:</strong><br>
                            {{ $employee->created_at->format('Y-m-d H:i') }}
                        </div>

                        <div class="mb-2">
                            <strong>{{ __('hrms.employee.last_updated') }}:</strong><br>
                        ...
                        <div class="mb-2">
                            ...
                            {{ $employee->hire_date->diffInYears(now()) }} {{ __('hrms.employee.years') }}
                        </div>
                        @endif

                        <div class="mb-2">
                            <strong>{{ __('hrms.employee.direct_reports') }}:</strong><br>
                            {{ $employee->directReports->count() }} {{ __('hrms.employee.employees_label') }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header card-header-custom">
                    <h5 class="mb-0">
                        <i class="fas fa-history"></i> {{ __('hrms.employee.recent_changes') }}
                    </h5>
                </div>
                <div class="card-body">
                    <div class="small text-muted">
                        ...
                        @unless($loop->last)
                        <hr class="my-2">@endunless
                        @empty
                        <p class="mb-0">{{ __('hrms.employee.no_recent_changes') }}</p>
                        @endforelse
                    </div>
                </div>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        statusField.addEventListener('change', function() {
            if (this.value === 'terminated' && originalStatus !== 'terminated') {
                if (!confirm('{{ __("hrms.employee.confirm_terminate") }}')) {
