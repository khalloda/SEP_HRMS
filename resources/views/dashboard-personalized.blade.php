...
.theme-hr-admin .card-header { background-color: var(--color-success); }
.theme-accounting .card-header { background-color: var(--color-warning); }
.theme-hr-coordinator .card-header { background-color: var(--color-info); }
.theme-employee .card-header { background-color: var(--color-primary); }
.theme-it-admin .card-header { background-color: var(--color-dark); }
</style>
@endpush
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (ctx) {
        new Chart(ctx, {
            type: 'line',
            data: {
                labels: {!! json_encode($analytics['charts_data']['labels'] ?? []) !!},
                datasets: {!! json_encode($analytics['charts_data']['datasets'] ?? []) !!}
            },
            options: {
                responsive: true,
