...
@section('title', __('hrms.salary_structure.create'))
...
<div class="container-fluid" x-data="salaryStructureForm()">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <div>
            <h1 class="h3 mb-1">{{ __('hrms.salary_structure.create') }} — {{ $employee->display_name }}</h1>
            <p class="text-muted mb-0">{{ __('hrms.salary_structure_help.define_currency_components') }}</p>
        </div>
        <a href="{{ route('employees.salary-structures.index', $employee) }}" class="btn btn-outline-secondary">
            <i class="fas fa-arrow-left"></i>
            <span class="ms-1">{{ __('hrms.salary_structure.view') }}</span>
        </a>
    </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">{{ __('hrms.new_structures_start_today_or_later') }}</div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">{{ __('hrms.leave_blank_structure_active') }}</div>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">{{ __('hrms.optional_memo_payroll_only') }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card"
                                ...
                                <div class="d-flex justify-content-between align-items-start gap-2">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <label class="form-label small text-muted mb-0">{{ __('hrms.salary_structure.component_value') }}</label>
                ...
                <div class="card-footer">
                    <div class="form-text">{{ __('hrms.priority_order_help') }}</div>
                </div>
            </div>
        </div>
