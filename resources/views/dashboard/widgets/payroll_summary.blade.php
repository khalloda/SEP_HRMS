    ...
    <div class="row text-center mb-3">
        ...
        <div class="col-4">
            <div class="text-success">
                ...
                <small>{{ __('With Structures') }}</small>
            </div>
        </div>
    </div>
    ...
    @else
        <div class="alert alert-info mt-3">
            <small>
                ...
                {{ __('Financial details restricted based on your role') }}
            </small>
        </div>
    @endif
@endif