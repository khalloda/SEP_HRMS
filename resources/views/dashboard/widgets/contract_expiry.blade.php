...
<div class="row text-center mb-3">
    <div class="col-4">
        <div class="text-danger">
            ...
            <small>{{ __('hrms.expiring_urgently') }}</small>
        </div>
    </div>
    <div class="col-4">
        <div class="text-warning">
            <div class="h4 mb-0">{{ $data['critical']->count() }}</div>
            <small>{{ __('hrms.expiring_critically') }}</small>
        </div>
    </div>
    <div class="col-4">
        <div class="text-info">
            <div class="h4 mb-0">{{ $data['soon'] }}</div>
            <small>{{ __('hrms.expiring_soon') }}</small>
        </div>
    </div>
</div>
...
<h6 class="text-danger mb-2">{{ __('hrms.expiring_urgently') }}</h6>
    ...
    <div class="list-group-item px-0 py-2">
        <div class="d-flex justify-content-between align-items-start">
            <div>
                ...
                <small class="text-muted">{{ app()->getLocale()==='ar' ? $contract->employee->department->name_ar : $contract->employee->department->name_en }}</small>
            </div>
            <div class="text-end">
...
<h6 class="text-warning mb-2">{{ __('hrms.expiring_critically') }}</h6>
