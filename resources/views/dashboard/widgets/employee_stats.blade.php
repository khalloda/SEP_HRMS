...
<div class="row text-center">
    <div class="col-6 mb-3">
        <div class="border-end">
            ...
            <small class="text-muted">{{ __('hrms.dashboard.total_employees') }}</small>
        </div>
    </div>
    <div class="col-6 mb-3">
...
<div class="row text-center">
    ...
    <div class="col-6">
        ...
        <small class="text-muted">{{ __('hrms.status.on_leave') }}</small>
    </div>
</div>

@if(count($data['departments']) > 0)
<hr class="my-3">
<h6 class="mb-2">{{ __('hrms.employee.by_department') }}</h6>
<div class="row">
