...
## Approach
- Added `resources/views/payroll/create.blade.php` with a Bootstrap form aligned to the controller validation (period dates, currency, notes, approval toggle).
...
## Rollback Plan
1. Delete `resources/views/payroll/create.blade.php`.
