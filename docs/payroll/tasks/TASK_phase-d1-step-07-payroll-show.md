...
- Surfaced cancellation audit details on the show view and backed it with a feature test to display the stored reason/actor (`app/Http/Controllers/PayrollController.php`, `resources/views/payroll/show.blade.php`, `tests/Feature/Payroll/PayrollShowViewTest.php`).
